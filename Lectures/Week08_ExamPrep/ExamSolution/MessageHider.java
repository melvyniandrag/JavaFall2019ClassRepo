public class MessageHider{
	...
	public static void hideMessage(String inputFile, String outputFile, byte[] message ){
		int[][] pixelArr = ReadPPMIntoIntArray(inputFile);
		setLastBits(pixelArr, message);
		WritePPMFile(pixelArr, outputFile);	
	}

	public static void setLastBits(int[][] pixelArr, byte[] message ){
		// This is what you need to implement	
	}

	public static int setLastBit(int i){
		return ( i | 0x00000001 );
	}

	public static int zeroLastBit(int i){
		return ( i & 0xFFFFFFFE );
	}
